      ...
      <div>
        <div className="flex p-10 pt-28 flex-col">
          <input
            ...
            className="block w-1/3 px-2 mb-4 rounded-md border-0 py-1.5 bg-gray-900 text-gray-50 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          ></input>
